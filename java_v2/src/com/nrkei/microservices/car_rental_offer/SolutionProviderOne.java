 ...
 */
public class SolutionProviderOne implements River.PacketListener {
    public static void main(String[] args) {
        String host = "localhost";
        String port = "5672";

        final RapidsConnection rapidsConnection = new RabbitMqRapids("solution_provider_1_in_java", host, port);
        ...
        river.register(new SolutionProviderOne());         // Hook up to the river to start receiving traffic
    }
    ...
    public void packet(RapidsConnection connection, Packet packet, PacketProblems warnings) {
        try {
            ...
            solutions.add("Solution from Provider 1");
